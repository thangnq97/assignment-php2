<?php require_once __DIR__."/header.php"?>
        <!-- banner -->
        <section class="bg-[#f1f2f1] grid grid-cols-2 gap-10 px-2 py-7">
            <div>
                <img class="object-cover w-full" src="./imgs/banner.png" alt="">
            </div>
            <div class="flex flex-col justify-center">
                <h2 class="text-[40px] font-[800] text-[#335154] leading-[50px] tracking-[3px] mb-8">Mach City 7 Bicycle
                </h2>
        ...
        <section class="grid grid-cols-4">
            <div class="flex flex-col gap-3 items-center py-9 border-r">
                <a class="flex justify-center" href="#">
                    <img class="w-[100px] h-[100px]" src="./imgs/contact1.png" alt="">
                </a>
            ...
            <div class="flex flex-col gap-3 items-center py-9 border-r">
                <a class="flex justify-center" href="#">
                    <img class="w-[100px] h-[100px]" src="./imgs/contact2.png" alt="">
                </a>
                <h3 class="text-[24px] font-[800] text-[#335154] px-5 my-4 max-w-[200px] text-center tracking-[1px]">
                ...
                <?php foreach($top4 as $item):?>
                    <div>
                        <a href="./product-detail?id=<?= $item->id?>">
                            <img class="object-cover" src="./imgs/<?= $item->image?>" alt="">
                        </a>
        ...
        <section class="grid grid-cols-4">
            ...
            <div class="flex flex-col items-center gap-6 py-8">
                <a href="#">
                    <img class="w-[100px] h-[100px] object-cover" src="./imgs/screwdriver.png" alt="">
                </a>
                <h3 class="text-[24px] font-[800] text-[#335154] px-5 my-4 max-w-[200px] text-center tracking-[1px]">Bicycle Repair Workshop</h3>
                <p class="text-[16px] font-[400] leading-[24px] text-[#393939] max-w-[220px] text-center">Bicycle restoration after collisions of any severity, including complete rebuilding.</p>
                <p class="text-[#df453e] text-[16px] font-[600] leading-[22px]">Read more</p>
            </div>
            <div class="flex flex-col items-center gap-6 py-8 bg-[#335154]">
                <a href="#">
                    <img class="w-[100px] h-[100px] object-cover" src="./imgs/gear.png" alt="">
                </a>
                <h3 class="text-[24px] font-[800] text-white px-5 my-4 max-w-[200px] text-center tracking-[1px]">Bicycle Repair Workshop</h3>
                <p class="text-[16px] font-[400] leading-[24px] text-[#A3B4B7] max-w-[220px] text-center">Bicycle restoration after collisions of any severity, including complete rebuilding.</p>
                <p class="text-[#df453e] text-[16px] font-[600] leading-[22px]">Read more</p>
            </div>
        </section>
        <!-- bestsellers -->
        ...
        <section class="bg-[#335154] grid grid-cols-5 gap-10 px-[50px] py-6">
                <a href="#">
                    <img src="./imgs/bicycle-01.png" alt="">
                </a>
                <a href="#">
                    <img src="./imgs/bicycle-02.png" alt="">
                </a>
                <a href="#">
                    <img src="./imgs/bicycle-03.png" alt="">
                </a>
                <a href="#">
                    <img src="./imgs/bicycle-04.png" alt="">
                </a>
                <a href="#">
                    <img src="./imgs/bicycle-05.png" alt="">
                </a>
        </section>
